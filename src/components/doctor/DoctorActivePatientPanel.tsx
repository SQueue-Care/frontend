...
export default function DoctorActivePatientPanel({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-indigo-100 bg-white shadow-sm">
      <div className="relative border-b border-indigo-100 bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 px-6 py-5 text-white">
      ...
      {allergies && (
        <div className="flex items-start gap-3 border-b border-rose-100 bg-rose-50 px-6 py-3">
          <svg
          ...
          <div>
            <p className="text-xs font-bold tracking-wide text-rose-700 uppercase">Alergi</p>
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            type="button"
            onClick={onOpenCdss}
            className="rounded-lg border border-violet-200 bg-violet-50 px-4 py-2 text-xs font-bold text-violet-700 transition-colors hover:bg-violet-100"
          >
            Analisis CDSS
          </button>
          <button
            type="button"
            onClick={onOpenNotes}
            className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-2 text-xs font-bold text-amber-800 transition-colors hover:bg-amber-100"
          >
            Catatan Dokter
          </button>
