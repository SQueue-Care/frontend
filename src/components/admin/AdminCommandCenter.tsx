  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          <h1 className="mb-1 font-['Manrope'] text-2xl font-extrabold text-zinc-950">
        ...
        <div className="group relative w-full md:w-64">
          <select
            ...
            className="relative z-10 block w-full cursor-pointer appearance-none rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-zinc-800 shadow-sm transition-all hover:border-teal-300 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:outline-none"
          >
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 z-20 flex items-center pr-3 text-slate-400 transition-colors group-hover:text-teal-500">
      ...
      <div className="mb-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="flex min-h-[400px] flex-col rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-teal-200 hover:shadow-xl lg:col-span-2">
          <div className="mb-6 flex items-center justify-between">
            <h3 className="font-['Manrope'] font-extrabold text-zinc-950">
              Analitik Performa Antrean
            </h3>
            <select
              value={analyticsDays}
              onChange={(e) => setAnalyticsDays(parseInt(e.target.value))}
              className="cursor-pointer rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-bold text-slate-600 transition-colors outline-none focus:ring-2 focus:ring-teal-500"
            >
        ...
        <div className="flex flex-col rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-teal-200 hover:shadow-xl">
          <h3 className="mb-6 font-['Manrope'] font-extrabold text-zinc-950">
