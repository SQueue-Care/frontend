...
export default function PatientNavbar({ toggleSidebar, activeView }: PatientNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white/80 dark:bg-[#131314]/80 backdrop-blur-md border-b border-slate-200 dark:border-zinc-800 text-sm py-3 lg:py-4 animate-in fade-in slide-in-from-top-8 duration-700 ease-out transition-colors">
      <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-6 lg:px-15 flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-3 sm:gap-x-5">
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-slate-50 dark:bg-[#1e1f20] border border-slate-200 dark:border-zinc-800 rounded-lg shadow-sm transition-colors">
            <svg className="w-4 h-4 text-teal-600 dark:text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            <span className="text-xs font-bold text-slate-600 dark:text-zinc-300 tracking-wide font-mono mt-0.5 transition-colors">
          ...
          <button type="button" className="relative p-2 text-slate-400 dark:text-zinc-500 hover:text-teal-600 dark:hover:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/30 rounded-full transition-colors focus:outline-none">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
            <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-rose-500 rounded-full border-2 border-white dark:border-[#131314] transition-colors"></span>
          </button>
        </div>
      </div>
    </header>
