      ...
      <div className="relative">
        {multiline ? (
          <textarea
            ...
            className="w-full resize-none rounded-xl border border-slate-200 bg-white px-4 py-3.5 text-sm text-zinc-900 shadow-sm transition-all outline-none placeholder:text-slate-400 dark:border-zinc-800 dark:bg-[#1e1f20] dark:text-zinc-100 dark:placeholder:text-zinc-600"
          />
        ) : (
          <input
            type={type}
