...
// Komponen Utilitas Objek Interseksi (Untuk Animasi Saat Digulir)
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          setIsVisible(true);
          observer.disconnect(); // Hentikan observasi setelah animasi muncul pertama kali
        }
      },
...
export default function Landing() {
  ...
  // Memicu animasi Hero Section saat pertama kali dirender
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#131314] font-['Inter'] antialiased flex flex-col transition-colors duration-500 overflow-x-hidden scroll-smooth">
      ...
      <header className={`fixed top-0 z-50 flex w-full justify-center border-b border-slate-200/50 dark:border-zinc-800/50 bg-white/70 dark:bg-[#131314]/70 backdrop-blur-xl transition-all duration-700 ease-out ${isMounted ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}>
        <div className="flex w-full max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            <a href="#prosedur" className="text-sm font-medium text-slate-500 dark:text-zinc-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-500">Prosedur</a>
            <a href="#live-queue" className="text-sm font-medium text-slate-500 dark:text-zinc-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-500">Live Antrean</a>
            <a href="#jadwal-dokter" className="text-sm font-medium text-slate-500 dark:text-zinc-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors duration-500">Jadwal Dokter</a>
      ...
      {/* 1. HERO SECTION (1 Layar Penuh) */}
      <section className="min-h-screen flex flex-col justify-center items-center w-full pt-20 px-6 relative">
        <div className={`absolute inset-0 z-0 pointer-events-none overflow-hidden transition-opacity duration-1000 ${isMounted ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className="relative z-10 grid w-full max-w-7xl grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
      ...
      {/* Social Proof Banner */}
      <AnimatedElement className="w-full border-y border-slate-200/80 dark:border-zinc-800 bg-white/40 dark:bg-[#1e1f20]/40 backdrop-blur-md py-5 transition-colors duration-500 z-10">
      ...
      {/* 2. SEKSI PROSEDUR (1 Layar Penuh) */}
      <section id="prosedur" className="min-h-screen flex flex-col justify-center items-center py-24 px-6 w-full max-w-7xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
          {[
            ...
            <AnimatedElement key={idx} delay={idx * 150} className="w-full">
              <div className="group flex flex-col bg-white dark:bg-[#1e1f20] p-8 rounded-3xl border border-slate-200 dark:border-zinc-800 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 h-full">
                ...
                <p className="font-['Inter'] text-sm font-medium text-slate-500 dark:text-zinc-400 leading-relaxed transition-colors duration-500">
                  {item.desc}
                </p>
              </div>
            </AnimatedElement>
      ...
      {/* 3. SEKSI LIVE ANTREAN (1 Layar Penuh) */}
      <section id="live-queue" className="min-h-screen flex flex-col justify-center items-center py-24 px-6 w-full relative z-10 bg-white/50 dark:bg-[#1e1f20]/30 border-y border-slate-200/50 dark:border-zinc-800/50">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          <AnimatedElement delay={100} className="order-2 lg:order-1 flex justify-center w-full">
          ...
          <AnimatedElement delay={300} className="order-1 lg:order-2 flex flex-col items-start gap-6">
      ...
      {/* 4. SEKSI JADWAL DOKTER (1 Layar Penuh) */}
      <section id="jadwal-dokter" className="min-h-screen flex flex-col justify-center items-center py-24 px-6 w-full max-w-7xl mx-auto z-10">
         <AnimatedElement className="text-center mb-16 w-full flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          {[
            ...
            { name: 'Dr. Faisal, Sp.THT', dept: 'Poli THT', time: '14:00 - 20:00 WIB', status: 'Tersedia', statusColor: 'emerald' },
             ...
             <AnimatedElement key={idx} delay={idx * 100} className="w-full">
      ...
      <section id="arsitektur" className="py-24 px-6 w-full max-w-7xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           <AnimatedElement delay={100} className="col-span-1 md:col-span-2">
           ...
           <AnimatedElement delay={200} className="col-span-1">
           ...
           <AnimatedElement delay={300} className="col-span-1 md:col-span-3">
      ...
      <footer className="w-full border-t border-slate-200 dark:border-zinc-800 bg-white dark:bg-[#131314] transition-colors duration-500 mt-auto py-12 px-6 relative z-10">
        <AnimatedElement className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
