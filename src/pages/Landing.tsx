        ...
        <div className="flex w-full max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-teal-600 shadow-sm">
              <span className="font-['Manrope'] text-lg text-white">RS</span>
            </div>
            <div className="flex flex-col">
              <span className="font-['Manrope'] text-lg leading-tight text-zinc-900">
                Ethereal
              </span>
              <span className="text-[10px] leading-tight tracking-widest text-teal-600 uppercase">
                Queue System
              </span>
            </div>
          </div>
          ...
          <nav className="hidden items-center gap-8 md:flex">
            <a
              href="#"
              className="text-sm text-zinc-600 transition-colors hover:text-teal-600"
            >
              Layanan
            </a>
            <a
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/auth"
              className="rounded-xl bg-linear-to-r from-[#0d9488] to-[#2563eb] px-6 py-2.5 text-sm text-white shadow-md shadow-teal-700/30 transition-opacity hover:opacity-90"
            >
              Masuk / Daftar
            </Link>
          </div>
        ...
        <div className="relative grid w-full max-w-7xl grid-cols-1 items-center gap-12 overflow-hidden rounded-3xl border border-slate-100 bg-white p-12 shadow-sm lg:grid-cols-2 lg:p-16">
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            <div className="flex items-center gap-2 rounded-full bg-teal-50 px-4 py-1.5">
              ...
              <span className="text-xs tracking-wider text-teal-800 uppercase">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-4">
              <Link
                to="/login"
                className="rounded-xl bg-emerald-700 px-8 py-4 text-base text-white shadow-lg shadow-emerald-700/20 transition-colors hover:bg-emerald-800"
              >
                Daftar Antrean
              </Link>
              <button className="rounded-xl bg-slate-100 px-8 py-4 text-base text-emerald-800 transition-colors hover:bg-slate-200">
              ...
              <div className="absolute right-6 bottom-6 left-6 flex items-center justify-between rounded-2xl border border-white/50 bg-white/90 p-4 shadow-xl backdrop-blur-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xl text-teal-800">12 Menit</span>
                  </div>
                </div>
                <div className="rounded-full bg-teal-100 px-3 py-1">
                  <span className="text-xs text-teal-800">Poli Anak</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex w-full max-w-7xl flex-col items-center gap-12">
          ...
          <div className="grid w-full grid-cols-1 gap-8 md:grid-cols-3">
            <div className="flex flex-col gap-4 rounded-3xl border border-slate-100 bg-white p-8 shadow-sm transition-shadow hover:shadow-md">
              ...
              <h3 className="font-['Manrope'] text-xl text-zinc-900">Prediksi Akurat</h3>
            ...
            <div className="flex flex-col gap-4 rounded-3xl border border-slate-100 bg-white p-8 shadow-sm transition-shadow hover:shadow-md">
              ...
              <h3 className="font-['Manrope'] text-xl text-zinc-900">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
            <div className="flex flex-col gap-6 md:col-span-1">
              <div className="flex items-center gap-3">
                ...
                <span className="font-['Manrope'] text-xl text-white">Ethereal</span>
              </div>
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-sm tracking-wider text-white uppercase">Akses Cepat</h4>
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-sm tracking-wider text-white uppercase">Bantuan</h4>
              <a href="#" className="text-sm text-slate-400 transition-colors hover:text-teal-400">
                Pusat Bantuan
              </a>
              <a href="#" className="text-sm text-slate-400 transition-colors hover:text-teal-400">
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-sm tracking-wider text-white uppercase">Kontak</h4>
